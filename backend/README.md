...
This project provides a comprehensive authentication setup using AWS Cognito user pools and an authorizer for serverless Lambda functions.
...
5. Replace example client id in <root>/backend/config.ts
6. Download SAM
7. Run Sam Deploy at <root>/backend
8. Replace your base URL in all the curl example comments and <root>/frontend
